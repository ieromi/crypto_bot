<h2>This telegram bot is built on aiogram3 + CoinMarketCap API using HTTP requests.</h2>This telegram bot is built on aiogram3 + CoinMarketCap API using HTTP requests.
